...
{
    internal class QueryHasMaxValInTu : QueryBase
    {
        internal QueryHasMaxValInTu(InfoStore infoStore) : base(infoStore) { }
        ...
        internal override double GetValue(HH hh, List<Person> tu, Person person)
        {
            ...
            temp_tu = temp_tu.OrderByDescending(p => minMaxVal.GetValue(hh, tu, p)).
