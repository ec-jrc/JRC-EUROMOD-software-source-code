...
namespace EM_Statistics.InDepthAnalysis
{
    internal class SystemInfo
    {
        ...
        {
            { InDepthDefinitions.ILS_EARNS, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_TAX, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_SICDY, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_SICER, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_SICCT, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_PEN, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_BENMT, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }, 
            { InDepthDefinitions.ILS_BENNT, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) },
            { InDepthDefinitions.ILS_ORIGY, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) },
            { InDepthDefinitions.ILS_SICEE, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) },
            { InDepthDefinitions.ILS_SICSE, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) },
            { InDepthDefinitions.ILS_EXTSTAT_OTHER, new Dictionary<string, IlVarInfo>(StringComparer.OrdinalIgnoreCase) }
        };

        bool isMacrovalidation = true;
            ...
            try
            {
                ...
                if (countryShortName != null)
                {
                    ...
                    foreach (string key in systemInfo.fiscalIls.Keys)
                    {
                        ...
                        if (key.Equals(InDepthDefinitions.ILS_ORIGY) && !systemInfo.isMacrovalidation)
                        {
                            continue;
                        }
                            // if this is "ils_sic" use the hard-coded list here! 
                            if (key.Equals(InDepthDefinitions.ILS_SICDYERCT))
                        foreach (string k in InDepthDefinitions.ILS_SICDYERCT_LIST)
