...
{
    public class BaselineReformPackage
    {
        ...
        public BaselineReformPackage() { }
        public BaselineReformPackage(FilePackageContent filePackage)
        {
        ...
        internal bool GetFilePackageContentMacrovalidation(out FilePackageContent fpc, out List<string> errors)
        {
            errors = new List<string>(); fpc = new FilePackageContent();
            ...
            if (!fpc.PathsAlt.Any())
                errors.Add($"No existing reform files found.");
            return fpc.PathsAlt.Any();
        }

        internal void UpdateSystemInfo(Settings settings, out List<string> errors)
        {
            errors = new List<string>();
            if (baseline != null && !string.IsNullOrEmpty(baseline.filePath))
            {
