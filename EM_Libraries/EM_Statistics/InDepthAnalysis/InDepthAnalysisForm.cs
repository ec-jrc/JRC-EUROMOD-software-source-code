...
{
    public partial class InDepthAnalysisForm : Form
    {
        ...
        private const string IN_DEPTH_ACKNOWLEDGEMENT = "The In-depth Analysis tool was developed as a part of the project " +
            ...
            "incorporate the tool to EUROMOD, which implies the public distribution of its compiled version under " +
        ...
        public InDepthAnalysisForm()
        {
            try
            {
                ...
                bool success = XML_handling.ParseTemplate(EM_Statistics.Resources.InDepthAnalysis_xml, out Template template, out ErrorCollector errorCollector, true);
        ...
        void UpdateForNewSettings()
        {
            ...
            foreach (BaselineReformPackage baselineReformPackage in currentSettings.baselineReformPackages)
            {
                int baseRow = gridBaselines.Rows.Add(
                    File.Exists(baselineReformPackage.baseline.filePath) ? Resources.existing_png : Resources.missing_png,
                ...
                foreach (BaselineReformPackage.BaselineOrReform reform in baselineReformPackage.reforms)
                {
                    ...
                    File.Exists(reform.filePath) ? Resources.existing_png : Resources.missing_png,
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                XML_handling.ParseTemplate(EM_Statistics.Resources.InDepthAnalysis_xml, out Template template, out _, true);
        ...
        private void newToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            currentSettings = new Settings() { baselineReformPackages = currentSettings?.baselineReformPackages };
        ...
        {
            MessageBox.Show($"In-depth Analysis tool. "+ System.Environment.NewLine + System.Environment.NewLine +  IN_DEPTH_ACKNOWLEDGEMENT, "About");
        }
