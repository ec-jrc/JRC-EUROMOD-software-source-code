...
namespace EM_Statistics.StatisticsPresenter
{
    public class StatisticsPresenter
    {
        ...
        public static void Run(Dictionary<string, object> arguments = null)
        {
            try
            {
                ...
                if (arguments != null)
                {
                    ...
                    {
                        MessageBox.Show("Statistics Presenter was called with invalid argument(s):" + Environment.NewLine +
            ...
            {
                MessageBox.Show($"Failed to run Statistics Presenter!{Environment.NewLine}{exception.Message}");
            }
