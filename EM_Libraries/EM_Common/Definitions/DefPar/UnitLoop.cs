...
namespace EM_Common
{
    ...
    {
        public static class UnitLoop
        {
            public const string Loop_Id = "Loop_Id";
            public const string Elig_Unit = "Elig_Unit";
            public const string Elig_Unit_Cond = "Elig_Unit_Cond";
            public const string Elig_Unit_Cond_Who = "Elig_Unit_Cond_Who";
